...
file <- getwd()
file
COMSAdata <- read.csv(file.path(file,"Data/20210304_all_WHO.csv"), stringsAsFactors = FALSE)
VASAvars <- read_dta(file.path(file,"Data/20210304eng_ext_child_VASA.dta"))
...
write.csv(EAVA,file.path(file,"/Data/Mar4.eava_child_comsa.csv"), row.names = FALSE)
