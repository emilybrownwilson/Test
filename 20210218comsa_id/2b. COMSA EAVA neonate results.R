...
file <- getwd()
file
# COMSAdata <- read.csv("/Users/EWilson/Desktop/COMSA Analysis/Raw to CalibratedVA input pipeline/For/20210218comsa_id/Data/all_WHO.csv", stringsAsFactors = FALSE)
COMSAdata <- read.csv("/Users/EWilson/Desktop/COMSA Analysis/Raw to CalibratedVA input pipeline/For/20210218comsa_id/Data/20210304_all_WHO.csv", stringsAsFactors = FALSE)
...
write.csv(EAVA,"/Users/EWilson/Desktop/COMSA Analysis/Raw to CalibratedVA input pipeline/For/20210218comsa_id/Data/Mar4.eava_neonate_comsa.csv", row.names = FALSE)
