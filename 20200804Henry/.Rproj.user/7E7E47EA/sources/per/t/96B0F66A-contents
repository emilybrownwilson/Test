...
EAVA$AIDS4 <- ifelse(COMSAdata$id10127 %in% "yes" |                             # positive dx by HCS
                       (COMSAdata$id10446 %in% "yes" | (COMSAdata$id10446 %in% c("dk","ref") &                            #
...
table(COMSAdata$id10184_units, COMSAdata$id10184_a)
table(COMSAdata$id10184_units, COMSAdata$id10184_b)
table(COMSAdata$id10184_a, COMSAdata$id10184_b, exclude = NULL)

table(COMSAdata$id10182, COMSAdata$id10184_b, exclude=NULL)
COMSAdata$diardur <- COMSAdata$id10184_b
COMSAdata$diardur[COMSAdata$diardur %in% c(99,9999)] <- NA

EAVA$diarrhea8 <- ifelse((COMSAdata$id10181 %in% "yes" & COMSAdata$id10183>4 & COMSAdata$id10183 %!in% 99 & !is.na(COMSAdata$id10183) & COMSAdata$id10186 %in% "no") |
                    (COMSAdata$id10181 %in% "yes" & COMSAdata$diardur>14 & COMSAdata$diardur %!in% 99 & !is.na(COMSAdata$diardur) & COMSAdata$id10186 %in% "no"),1,2)
...
# then dysentery8=1;
# else dysentery8=2;
EAVA$dysentery8 <- ifelse((COMSAdata$id10181 %in% "yes" & COMSAdata$id10183>4 & COMSAdata$id10183 %!in% 99 & !is.na(COMSAdata$id10183) & COMSAdata$id10186 %in% "yes") | 
                            (COMSAdata$id10181 %in% "yes" & COMSAdata$diardur>14 & !is.na(COMSAdata$diardur) & COMSAdata$id10186 %in% "yes"), 1,2)
table(EAVA$dysentery8, exclude=NULL)
...
EAVA$possiblediar8_4 <- ifelse(COMSAdata$id10181 %in% "yes" & (COMSAdata$id10147 %in% "yes" | COMSAdata$id10219 %in% "yes" | COMSAdata$id10218 %in% "yes") & COMSAdata$id10186 %in% "no" & EAVA$diarrhea8 %in% 2, 1,2)
...
EAVA$possibledysn8_4 <- ifelse(COMSAdata$id10181 %in% "yes" & (COMSAdata$id10147 %in% "yes" | COMSAdata$id10219 %in% "yes" | COMSAdata$id10218 %in% "yes") & COMSAdata$id10186 %in% "yes" & EAVA$dysentery8 %in% 2, 1,2)
...
table(EAVA$possdiardysn8_4, exclude=NULL)
...
# else hemfever=2;
EAVA$hemfever <- ifelse(COMSAdata$id10147 %in% "yes" & (COMSAdata$id10241 %in% "yes" | COMSAdata$id10239 %in% "yes"), 1,2)
...
# else malaria251=2;
EAVA$malaria251 <- ifelse((COMSAdata$id10147 %in% "yes" & COMSAdata$id10149 %in% "yes" & COMSAdata$id10151 %in% "on_and_off" & COMSAdata$id10208 %in% "no" & COMSAdata$id10278 %in% "no" & (COMSAdata$id10268 %in% "yes" | COMSAdata$id10159 %in% "yes" | COMSAdata$id10219 %in% "yes" | COMSAdata$id10218 %in% "yes")) |
                          (COMSAdata$id10147 %in% "yes" & COMSAdata$id10149 %in% "yes" & COMSAdata$id10150 %in% "severe" & COMSAdata$id10208 %in% "no" & COMSAdata$id10278 %in% "no" & (COMSAdata$id10268 %in% "yes" | COMSAdata$id10219 %in% "yes" | COMSAdata$id10218 %in% "yes")), 1,2)
table(EAVA$malaria251)
...
# else measles4=2;
EAVA$measles4 <- ifelse(COMSAdata$age>=120 & (COMSAdata$id10147 %in% "yes" & COMSAdata$id10148>2 & COMSAdata$id10148 %!in% 99 & !is.na(COMSAdata$id10148)) & 
                       (COMSAdata$id10233 %in% "yes" & COMSAdata$id10234>2 & COMSAdata$id10234 != 99 & !is.na(COMSAdata$id10148) & COMSAdata$id10235 %in% c("face", "everywhere")), 1, 2)
...
EAVA$pertussis <- ifelse((COMSAdata$id10153 %in% "yes" & COMSAdata$id10154>14 & COMSAdata$id10154 %!in% 99 & !is.na(COMSAdata$id10154)) & (COMSAdata$id10156 %!in% "yes" | COMSAdata$id10158 %in% "yes" | COMSAdata$id10173 %in% c("stridor","stridor wheezing","stridor  wheezing","stridor grunting wheezing")), 1,2)
...
#                             COMSAdata$id10147=="yes" | COMSAdata$id10219=="yes" | COMSAdata$id10216 == c(1, 2, 3)) & EAVA$pertussis==2 & EAVA$pneumoniafb2daysgr==2, 1,2)
EAVA$possibleari3 <- ifelse((COMSAdata$id10153 %in% "yes" | COMSAdata$id10159 %in% "yes" | (COMSAdata$id10166 %in% "yes" & (COMSAdata$id10172 %in% "yes" | COMSAdata$id10173 %in% c("grunting","grunting wheezing","stridor","stridor  wheezing","stridor grunting","stridor grunting wheezing","wheezing")))) &
                           (COMSAdata$id10156 %in% "yes" | COMSAdata$id10166 %in% "yes" | COMSAdata$id10172 %in% "yes" | COMSAdata$id10173 %in% c("grunting","grunting wheezing","stridor","stridor  wheezing","stridor grunting","stridor grunting wheezing","wheezing") |
...
EAVA$sepsis_nomal251 <- ifelse(COMSAdata$id10147 %in% "yes" & (COMSAdata$id10235  %in% c("trunk_or_abdomen", "everywhere") | COMSAdata$id10219 %in% "yes" | COMSAdata$id10218 %in% "yes") & EAVA$malaria251 %in% 2, 1,2)
...
EAVA$malaria_possible <- ifelse(EAVA$residual_infect_slide15_4 %in% 1 & COMSAdata$c3101 %in% c(2,3), 1,2)
table(EAVA$source, EAVA$malaria_possible, exclude=NULL)
...
#                                  (EAVA$injury==1 & COMSAdata$id10147==1 & COMSAdata$q5403a=="days" & COMSAdata$id10148 < COMSAdata$q5403), 1,2)

EAVA$injury3_slide15_4 <- ifelse((EAVA$injury %in% 1 & COMSAdata$id10120<=1) |
                                 (EAVA$injury %in% 1 & EAVA$AIDS4 %!in% 1 & EAVA$measles4 %!in% 1 & EAVA$meningitis %!in% 1 & EAVA$dysentery8 %!in% 1 & EAVA$diarrhea8 %!in% 1 & EAVA$pneumoniafb2daysgr %!in% 1 & EAVA$malaria251 %!in% 1 &
                                  EAVA$possibledysn8_4 %!in% 1 & EAVA$possiblediar8_4 %!in% 1 & EAVA$possibleari3 %!in% 1 & EAVA$hemfever %!in% 1 & EAVA$sepsis_nomal251 %!in% 1 & EAVA$residual_infect_slide15_4 %!in% 1) |
                                 (EAVA$injury %in% 1 & COMSAdata$id10147 %in% "yes"), 1,2)

table(EAVA$injury3_slide15_4, exclude=NULL)
table(EAVA$injury, EAVA$injury3_slide15_4, exclude=NULL)
#################################################### ADD NN CAUSES
...
table(COMSAdata$id10219, COMSAdata$id10275)
table(COMSAdata$id10219, COMSAdata$id10276)
...
EAVA$allexpertdxs[is.na(EAVA$allexpertdxs) & EAVA$malaria_possible==1] <- "Malaria"
...
# write.csv(EAVA,file.path(file,"/Data/eava_child_comsa.csv"), row.names = FALSE)
...
varlist2a <- c(
  "ID",
  "id10077","id10120","illdur","id10147",
  "id10244","id10200","id10181","id10182","id10147","id10148","id10233","id10234","id10166","id10172",
  "id10249","id10250","illdur",
  "age","id10147","id10148","id10233","id10234","id10235",
  "id10147","id10208","id10278",
  "id10181","id10183","id10186","id10184_b",
  "id10181","id10147","id10219","id10214","id10218","id10186",
  "id10153","id10154","id10156","id10158","id10173",
  "id10153","id10154","id10159","id10161","id10166","id10167","id10172","id10173",
  "id10147","id10149","id10150","id10151","id10208","id10278","id10268","id10159","id10219","id10214","id10218",
  "id10153","id10159","id10166","id10172","id10173","id10156","id10166","id10172","id10173","id10147","id10219","id10214","id10218",
  "id10147","id10241","id10239",
  "id10147","id10235","id10219","id10214","id10218",
  "id10147")

varlist2b <- c(
  "ID",
  "injury3_slide15_4","injury","AIDS4","measles4","meningitis","dysentery8","diarrhea8","pneumoniafb2daysgr","malaria251","possibledysn8_4","possiblediar8_4","possibleari3","hemfever","sepsis_nomal251","residual_infect_slide15_4",
  "AIDS4", 
  "malnutrition2",
  "measles4",
  "meningitis",
  "diardysn8","possibledysn8_4","diarrhea8","dysentery8",
  "pertussis",
  "pneumoniafb2daysgr",
  "malaria251",
  "possibleari3", "pertussis","pneumoniafb2daysgr",
  "hemfever",
  "sepsis_nomal251","malaria251",
  "residual_infect_slide15_4","measles4","meningitis","malaria251","dysentery8","diarrhea8","pertussis","pneumoniafb2daysgr","sepsis_nomal251","possibledysn8_4","possiblediar8_4","possibleari3","hemfever",
  "allexpertdxs")

columnsEAVA2 <- c(
  "ID",
  "injury3_slide15_4","injury","id10077","id10120","illdur","AIDS4","measles4","meningitis","dysentery8","diarrhea8","pneumoniafb2daysgr","malaria251","possibledysn8_4","possiblediar8_4","possibleari3","hemfever","sepsis_nomal251","residual_infect_slide15_4","id10147",
  "AIDS4","id10244","id10200","id10181","id10182","id10147","id10148","id10233","id10234","id10166","id10172",
  "malnutrition2","id10249","id10250","illdur",
  "measles4", "age","id10147","id10148","id10233","id10234","id10235",
  "meningitis","id10147","id10208","id10278",
  "diardysn8","id10181","id10183","id10186","id10184_b",
  "possibledysn8_4","id10181","id10147","id10219","id10214","id10218","id10186","diarrhea8","dysentery8",
  "pertussis","id10153","id10154","id10156","id10158","id10173",
  "pneumoniafb2daysgr","id10153","id10154","id10159","id10161","id10166","id10167","id10172","id10173",
  "malaria251","id10147","id10149","id10150","id10151","id10208","id10278","id10268","id10159","id10219","id10214","id10218",
  "possibleari3", "id10153","id10159","id10166","id10172","id10173","id10156","id10166","id10172","id10173","id10147","id10219","id10214","id10218","pertussis","pneumoniafb2daysgr",
  "hemfever", "id10147","id10241","id10239",
  "sepsis_nomal251","id10147","id10235","id10219","id10214","id10218","malaria251",
  "residual_infect_slide15_4","id10147","measles4","meningitis","malaria251","dysentery8","diarrhea8","pertussis","pneumoniafb2daysgr","sepsis_nomal251","possibledysn8_4","possiblediar8_4","possibleari3","hemfever",
  "allexpertdxs")

COMSAdata2 <- COMSAdata[,varlist2a]

EAVA2 <- EAVA[varlist2b]

colnames(COMSAdata2)
colnames(EAVA2)
columnsEAVA2

EAVAunspecified <- merge(COMSAdata2,EAVA2, by=c("ID"))
colnames(EAVAunspecified)
EAVAunspecified <- EAVAunspecified[columnsEAVA2]

table(EAVAunspecified$allexpertdxs, exclude = NULL)

EAVAunspecified <- subset(EAVAunspecified, allexpertdxs %in% c("Unspecified"))

write.csv(EAVAunspecified,"/Users/EWilson/Desktop/Raw to CalibratedVA input pipeline/20200804forHenry/EAVA.COMSA.child-unspecified.csv", row.names = FALSE)
