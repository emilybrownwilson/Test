...
# Objective: run InsilicoVA on COMSA data, after mapping variables, and produce CODs for 0-1m, 1-59m, 5-19y, and stillbirths 
...
COMSAdata$group[COMSAdata$ageatdeath >= 60*30.4 & COMSAdata$ageatdeath < 20*365.25] <- "ch5_19y"
...
dim(IV5data.ch1_59m)
IV5data.ch5_19y <- subset(COMSAdata, group=="ch5_19y")
dim(IV5data.ch5_19y)
...
IV5data.ch5_19y.subset <- IV5data.ch5_19y[, c(names.use)]
...
IV5data.ch5_19y <- setcolorder(IV5data.ch5_19y.subset, names(sample_test))
