...
# else nnt1=2;
EAVA$nnt1 <- ifelse(COMSAdata$age > 2 & COMSAdata$age != "NULL" & COMSAdata$id10219 %in% "yes" & ((COMSAdata$id10271 %in% "yes" & COMSAdata$id10273 %in% "yes") | (COMSAdata$id10106 <= 5 & COMSAdata$id10107 %in% "yes"))  ,1,2)
...
# EAVA$congmalf2a <- ifelse(COMSAdata$id10373=="yes" | COMSAdata$id10372=="yes" | COMSAdata$id10371=="yes", 1,2) # vacq3034other="PIEDS ARQUES ET BOSSE AU LOMBA" or vacq3034other="FENTE SUR LA TETE" or vacq3034other="SPINA BIFIDA" or vacq3034other="L ESTOMAC ET LES INTESTINS")  ,1,2)
...
EAVA$pneumo157sign3 <- ifelse(COMSAdata$id10173 %in% c("grunting","grunting dk","grunting wheezing","stridor grunting","stridor grunting wheezing","yes"), 1,0)  # grunting;
...
write.csv(EAVA,file.path(file,"/Data/eava_neonate_champs.csv"), row.names = FALSE)
