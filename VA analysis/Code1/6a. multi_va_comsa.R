...
test <- getTopCOD(InterVA5.neonate)
sort(unique(as.character(test$cause)))
test <- getTopCOD(codeVAInsilico.neonate)
sort(unique(as.character(test$cause)))

test <- getTopCOD(InterVA5.ch1_59)
sort(unique(as.character(test$cause)))
test <- getTopCOD(codeVAInsilico.ch1_59)
sort(unique(as.character(test$cause)))

test <- getIndivProb(InterVA5.neonate)
sort(colnames(test))
test <- getIndivProb(codeVAInsilico.neonate)
sort(colnames(test))

test <- getIndivProb(InterVA5.ch1_59)
sort(colnames(test))
